...
const itemObj0 = {
    0: {name: 'Dinotaeng 卡夾 零錢包', price: '650', img: 'img/p1-1.jpg', url: '#'},
    1: {name: 'Dinotaeng 棉花糖平板包', price: '1200', img: 'img/p1-2.jpg', url: '#'},
    2: {name: 'Dinotaeng 手機支架', price: '460', img: 'img/p1-3.jpg', url: '#'},
    3: {name: 'Second Morning 手機殼', price: '599', img: 'img/p1-4.jpg', url: '#'},
    4: {name: 'Second Morning 耳機殼 ', price: '550', img: 'img/p1-5.jpg', url: '#'},
    5: {name: 'Second Morning 平板 / 筆電包', price: '1200', img: 'img/p1-6.jpg', url: '#'},
    6: {name: 'EPT COURT 經典黑白 板鞋', price: '3950', img: 'img/p2-1.jpg', url: '#'},
    7: {name: 'EPT COURT 灰白拼接 板鞋', price: '3950', img: 'img/p2-2.jpg', url: '#'},
    8: {name: 'NERDY 23SS Poach 經典板鞋', price: '1880', img: 'img/p2-3.jpg', url: '#'},
    9: {name: 'LEE 帆布袋', price: '1280', img: 'img/p3-1.jpg', url: '#'},
    10: {name: 'NEIKIDNIS Mesh String後背包', price: '1650', img: 'img/p3-2.jpg', url: '#'},
    11: {name: 'WOOALONG 經典刺繡老帽', price: '880', img: 'img/p4-1.jpg', url: '#'},
    12: {name: 'LEE 24SS老帽', price: '950', img: 'img/p4-2.jpg', url: '#'},
    13: {name: 'Marithe 24SS老帽', price: '1180', img: 'img/p4-3.jpg', url: '#'},
    14: {name: 'Marithe 襪子三入組', price: '680', img: 'img/p4-4.jpg', url: '#'},
    15: {name: 'LEE 刺繡小標襪子 ', price: '199', img: 'img/p4-5.jpg', url: '#'},
    16: {name: 'RECLOW RC B26韓國眼鏡', price: '980', img: 'img/p4-6.jpg', url: '#'},
    17: {name: 'RECLOW RC B019黑框眼鏡', price: '1280', img: 'img/p4-7.jpg', url: '#'}
